    ...
    <header className="bg-white border-b sticky top-0 z-10">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center">
          <Link to="/student/dashboard" className="flex items-center space-x-2 mr-6">
            <Hospital className="h-6 w-6 text-primary" />
            <span className="text-xl font-bold">MedAttend</span>
          </Link>

          <nav className="hidden md:flex items-center space-x-6">
            <Link to="/student/dashboard" className="text-sm font-medium">
              Dashboard
            </Link>
            <Link to="/student/schedule" className="text-sm font-medium text-muted-foreground">
              Schedule
            </Link>
            <Link to="/student/attendance" className="text-sm font-medium text-muted-foreground">
              My Attendance
            </Link>
            <Link to="/student/reports" className="text-sm font-medium text-muted-foreground">
              Reports
            </Link>
          </nav>
        </div>
